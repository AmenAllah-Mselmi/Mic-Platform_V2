        ...
        <div className='relative rounded-lg bg-white shadow dark:bg-gray-700'>
          ...
          <div className='p-4 text-center md:p-5'>
            ...
            <button
              ...
              type='button'
              className='inline-flex items-center rounded-lg bg-MIC px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300'
            >
              Yes, I am sure
            </button>
            <button
